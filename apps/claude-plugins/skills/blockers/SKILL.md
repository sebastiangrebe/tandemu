---
name: blockers
description: Show team friction and blockers. Combines friction telemetry from Tandem (prompt loops, errors by file) with blocked/stale tasks from the connected ticket system to surface what's slowing the team down.
...
- Task data is live from the connected ticket system via Tandem API
- Friction data is from ClickHouse telemetry via Tandem API
